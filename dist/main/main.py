...
banco = sqlite3.connect('salao3.db')
        ...
        if nomage != "" and nomagefun != "" and datage != "":
            ...
            if resp == QMessageBox.Yes:
                ...
                while len(navegador.find_elements(By.ID, 'side')) < 1:
                    time.sleep(1)
                time.sleep(2)
                navegador.find_element(By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/'
        ...
        if resp == QMessageBox.Yes:
            ...
            for (telefone, cliente) in cursor:
                ...
                while len(navegador.find_elements(By.ID, 'side')) < 1:
                    time.sleep(1)
                time.sleep(2)
                navegador.find_element(By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[2]/'
                                                 'button/span').click()
